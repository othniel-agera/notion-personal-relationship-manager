...
describe("/auth", function () {
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, common_spec_1.UserModel.deleteMany({})];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, common_spec_1.UserModel.insertMany(users)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, common_spec_1.request)(common_spec_1.app).get("/auth/users")];
                    case 2:
                        res = _a.sent();
                        (0, common_spec_1.expect)(res.status).to.equal(200);
                        (0, common_spec_1.expect)(res.body.data.users.length).to.equal(3);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("GET /users/:id", function () {
        it("should return a user if valid id is passed", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, common_spec_1.request)(common_spec_1.app).get("/auth/users/" + user._id)];
                    case 2:
                        res = _a.sent();
                        (0, common_spec_1.expect)(res.status).to.equal(200);
                        (0, common_spec_1.expect)(res.body.data.user).to.have.property("username", user.username);
                        return [2 /*return*/];
                }
            });
        }); });
        it("should return 404 error when invalid object id is passed", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, common_spec_1.request)(common_spec_1.app).get("/auth/users/1")];
                    case 1:
                        res = _a.sent();
                        (0, common_spec_1.expect)(res.status).to.equal(400);
                        return [2 /*return*/];
                }
            });
        }); });
        it("should return 404 when valid object id is passed but does not exist", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, common_spec_1.request)(common_spec_1.app).get("/auth/users/123456789012")];
                    case 1:
                        res = _a.sent();
    ...
    describe("POST /signup", function () {
        it("should return new user when all request body is valid to signup", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, common_spec_1.request)(common_spec_1.app).post("/auth/signup").send({
                            username: "lenzo",
                            password: "12345678",
                            email: "string",
                            address: "string",
                    ...
                    case 1:
                        res = _a.sent();
                        (0, common_spec_1.expect)(res.status).to.equal(200);
                        (0, common_spec_1.expect)(res.body.data.user).to.have.property("username", "lenzo");
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, common_spec_1.expect)(loginWrongUsernameRes.status).to.equal(401);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        (0, common_spec_1.expect)(loginWrongPasswordRes.status).to.equal(402);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        (0, common_spec_1.expect)(res.status).to.equal(200);
                        (0, common_spec_1.expect)(res.body.data.user).to.have.property("username", "lenzo");
                        return [4 /*yield*/, (0, common_spec_1.request)(common_spec_1.app).post("/auth/login").send({
                                username: "lenzo",
                                password: "12345678",
                                email: "string",
                                address: "string",
                    ...
                    case 2:
                        loginRes = _a.sent();
                        (0, common_spec_1.expect)(loginRes.status).to.equal(200);
                        return [2 /*return*/];
                }
            });
        }); });
